...
TEST(numGraph) {
    ...
    Graph<int, int, int>* graph =
        new AdjacencyListUndirectedGraph<int, int, int>();
...
TEST(dfsSocialNetwork25) {
    Graph<string, int, int>* graph =
        readGraphFile("test_data/unit_tests/socialNetwork_25.graph");
...
TEST(dfsSocialNetwork1000) {
    Graph<string, int, int>* graph =
        readGraphFile("test_data/unit_tests/socialNetwork_1000.graph");
    vector<string> vertices = graph->getVertices();
...
TEST(dfsSocialNetworkDisconnected20) {
    Graph<string, int, int>* graph = readGraphFile(
        "test_data/unit_tests/socialNetworkDisconnected_20.graph");
    vector<string> vertices = graph->getVertices();
...
TEST(bfsSocialNetwork25) {
    ...
    path = {"Sam Curlytail", "Napoleon Floyd", "Kevin Bacon"};
...
TEST(bfsSocialNetwork1000) {
    ...
    checkEqualPath(path, shortestLengthPathBFS(string("Sam Curlytail"),
                                               string("Kevin Bacon"), graph));
    path = {"Napoleon Boar", "Takako Bland", "Kevin Bacon"};
    checkEqualPath(path, shortestLengthPathBFS(string("Napoleon Boar"),
                                               string("Kevin Bacon"), graph));
    path = {"Lester Strangepork", "Kevin Bacon"};
    checkEqualPath(path, shortestLengthPathBFS(string("Lester Strangepork"),
                                               string("Kevin Bacon"), graph));
    path = {"Annie Sue Saddlebottom", "Truffles Floyd", "Kevin Bacon"};
    checkEqualPath(path, shortestLengthPathBFS(string("Annie Sue Saddlebottom"),
                                               string("Kevin Bacon"), graph));
    delete graph;
}
...
TEST(ssspTown8) {
    ...
    Graph<string, int, int>* graph =
        readGraphFile("test_data/unit_tests/town_8.graph");
    Dictionary<string, int>* results =
...
TEST(ssspTown100) {
    // Creates an undirected graph
    Graph<string, int, int>* graph =
        readGraphFile("test_data/unit_tests/town_100.graph");
    Dictionary<string, int>* results =
